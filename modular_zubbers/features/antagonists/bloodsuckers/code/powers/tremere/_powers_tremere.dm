...
/datum/action/cooldown/bloodsucker/targeted/tremere
	...
	button_icon = 'modular_zubbers/features/antagonists/bloodsuckers/icons/actions_tremere_bloodsucker.dmi'
	background_icon = 'modular_zubbers/features/antagonists/bloodsuckers/icons/actions_tremere_bloodsucker.dmi'
